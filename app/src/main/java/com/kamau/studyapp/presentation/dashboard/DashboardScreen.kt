    ...
    Column(modifier = modifier) {
        ...
        if (subjectList.isEmpty()) {
            Image(
                ...
                modifier = Modifier
                    .size(120.dp)
                    .align(Alignment.CenterHorizontally) // Proper use of align
            )
            Text(
                text = emptyListText,
                style = MaterialTheme.typography.bodySmall,
...
//                modifier = Modifier.align(Alignment.CenterHorizontally) // Aligns text in the center
            )
        }
        LazyRow (
